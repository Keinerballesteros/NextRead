  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: "La información del libro ha sido guardada exitosamente",
        timer: 3000,
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Hubo un error al publicar el libro. Intenta nuevamente.",
        timer: 3000,
      });
    } finally {
      setIsSubmitting(false);
    ...
    <section className="flex items-center justify-center min-h-screen bg-[#f0f0f0] py-8">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl p-8 border border-gray-200 mx-4">
        ...
        <p className="text-center text-gray-600 mb-8">
          Completa la información de tu libro para publicarlo
        </p>
